        ...
        <div class="sidebar-nav">
            <ul class="side-nav color-gray">
                ...
                <li class="has-children">
                    <a href="#"><i class="fa fa-file-text"></i> <span>Ciclo Escolar</span> <i class="fa fa-angle-right arrow"></i></a>
                    <ul class="child-nav">
                        <li><a href="create-class.php"><i class="fa fa-plus"></i> <span>Crear Ciclo Escolar</span></a></li>
                        <li><a href="manage-classes.php"><i class="fa fa-bars"></i> <span>Gestionar Ciclo Escolar</span></a></li>
